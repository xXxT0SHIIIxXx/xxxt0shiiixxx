...
/*  
    ...
    8: 64 pages
        Micro
*/
const BGCOLOR = '#121212'; // Change this hex value to set the background color. Remember to keep the quotes!
const ALT = 'Take Control Issue: 1'; // Change this to a plaintext copy or description of your content to make it visible to screen-readers
